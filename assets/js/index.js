    ...
    toRGB = (hex, reversed, integer) => {
        ...
        embed: {
            ...
            author: {
                name: "Author name",
                url: "https://discord.com",
                icon_url: "https://i.imgur.com/nx3GWp4.png"
            },
            thumbnail: {
                url: "https://i.imgur.com/nx3GWp4.png"
            },
            image: {
                url: "https://i.imgur.com/eq9un5H.png"
            },
            footer: {
                text: "Footer text",
                icon_url: "https://i.imgur.com/nx3GWp4.png"
...
window.onload = () => {
    ...
    let notif = document.querySelector('.notification'),
        ...
        makeShort = (txt, length, mediaWidth) => {
            ...
            txt = txt
                .replace(/\&#60;:[^:]+:(\d+)\&#62;/g, '<img class="emoji" src="https://i.imgur.com/nx3GWp4.png"/>')
